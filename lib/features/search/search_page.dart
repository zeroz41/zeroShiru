  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(child: ZeroAnimatedSwitcher(child: _body())),
      ],
    );
  }
      ...
      children: [
        GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
            ...
            childAspectRatio: ZeroTokens.cardAspect,
        ...
        if (_error != null && !_loading)
          Positioned(
            left: ZeroTokens.space5,
            right: ZeroTokens.space5,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              AnimatedSize(
                duration: reduceMotion ? Duration.zero : ZeroTokens.motionPanel,
                curve: ZeroTokens.easeSettle,
                alignment: Alignment.topCenter,
                child: filtersOpen
                    ? Padding(
                        padding: const EdgeInsets.only(top: ZeroTokens.space4),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (_, _) => const SizedBox(width: ZeroTokens.space2),
        itemBuilder: (context, index) {
...
class _PageLoadFailure extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Padding(
        padding: const EdgeInsets.only(left: ZeroTokens.space4),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
