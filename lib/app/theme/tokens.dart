...
abstract final class ZeroTokens {
  // ---------------------------------------------------------------------------
  // rem conversion
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // Colors — two accents! #E5204C is the seekbar ONLY; #7C3AED is the app.
  // ---------------------------------------------------------------------------
  ...
  static const Color accentVeryLight = Color(0xFFC4B5FD);

  /// `--tertiary-color-dim`. Link hover.
  static const Color accentDim = Color(0xFF4C1D95);
  ...
  /// Primary controls share the brand ramp instead of introducing another hue.
  ...
  static const Color cardHoverBorder = Color(0x6B7C3AED);
  ...
  static const Color ambientBloomTopRight = Color(0x2B7C3AED);
  ...
  static const Color navPillRing = Color(0x807C3AED); // hsla(tertiary,.5)
  static const Color navPillGradTop = Color(0x6B7C3AED); // .42
  static const Color navPillGradBottom = Color(0x337C3AED); // .2
