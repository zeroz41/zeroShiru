...
import 'package:zero/infrastructure/platform/log_sink.dart';

void main() {
  late Directory dir;

  setUp(() {
    dir = Directory.systemTemp.createTempSync('zero-log-test');
  });
  ...
  test('export copies the log out as zero-<epoch>.log', () {
    ...
    sink.close();
    expect(p.basename(exported.path), matches(RegExp(r'^zero-\d+\.log$')));
