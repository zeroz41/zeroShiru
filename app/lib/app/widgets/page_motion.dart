...
class _PageMotionState extends State<PageMotion>
  ...
  late final AnimationController _controller = AnimationController(
    vsync: this,
    duration: ShiruTokens.motionPageFade,
    value: 1,
  );
...
class ShiruAnimatedSwitcher extends StatelessWidget {
  const ShiruAnimatedSwitcher({
    super.key,
    required this.child,
    this.duration = ShiruTokens.motionPanel,
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedSwitcher(
      ...
      reverseDuration: reduceMotion ? Duration.zero : ShiruTokens.motion,
