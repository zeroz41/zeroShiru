...
import 'package:zeroshiru/infrastructure/learning/local_japanese_learning_tools.dart';
import 'package:zeroshiru/infrastructure/network/transport.dart';

void main() {
  final archivePath = Platform.environment['ZEROSHIRU_JMDICT_ARCHIVE']?.trim();
  ...
  test(
    ...
    skip: archivePath == null || archivePath.isEmpty
        ? 'Set ZEROSHIRU_JMDICT_ARCHIVE to a downloaded JMdict_english.zip.'
        : false,
